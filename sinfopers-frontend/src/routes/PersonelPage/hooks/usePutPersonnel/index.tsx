// src/routes/PersonelPage/hooks/usePutPersonnel/index.tsx
...
export const usePutPersonnelWithAuth = () => {
  ...
  return async (data: PersonnelDataInterface) => {
    ...
    try {
      const response = await axiosClient.put(`/personil/${data.id}/`, personnelData);
      return response.data.success;
    } catch (error) {
      console.error("Error updating personnel:", error);
      throw error;
