...
import { z } from "zod";
import { PersonnelAttribute } from "@/routes/PersonelPage/hooks/types";
        ...
        <FormItem className="grid grid-cols-4 items-center gap-4 w-full">
          ...
          <div>
            <Popover open={open} onOpenChange={setOpen}>
              <PopoverTrigger className="md:w-[464px] sm:w-96" asChild>
                <FormControl>
                  <Button
                    ...
                    role="combobox"
                    aria-expanded={open}
                    className="justify-between rounded-xl border-gray-400 font-normal text-nowrap text-clip w-full"
                  >
              ...
              <PopoverContent 
                className="md:w-[464px] sm:w-96 p-0" 
                align="start"
                side="bottom"
              >
                <Command>
